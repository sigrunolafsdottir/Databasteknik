...
('Ambrosia','Globen', (select id from country where name = 'Sweden'), 1),
('Bertil','Stadshuset', 1, 1),
('Camelia','Perlan', 2, true),
('Doris','Big Ben', 3, 1),
('Efraim','Madame Tusseaus', 3, false),
...
update child set name = 'Kalle' where name = 'Hulken';
