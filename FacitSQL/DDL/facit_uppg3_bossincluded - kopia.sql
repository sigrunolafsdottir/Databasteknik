...
-- foreign key (bosselfId) references bosself(id) on delete set null);
...
alter table elf add constraint foreign key (bosselfId) references bosself(id) on delete set null;
...
-- önskvärt men funkar inte pga inga bossar inlagda i bosstabellen än
...
insert into elf (name, bosselfId)  values
('Santa', null), ('Glader', null),('Toker', null),('Trotter', null),('Prosit', null),('Butter', null)
,('Glader', null),('Blyger', null),('Blyger', null),('Skumtomten', null)
,('Surtomten', null), ('Gladtomten', null);
...
insert into bosself (elfId)  values
(10),(11);


update elf set bosselfId =1 where name = 'Santa';
update elf set bosselfId =1 where name = 'Glader';
update elf set bosselfId =2 where name = 'Toker';
update elf set bosselfId =1 where name = 'Trotter';
update elf set bosselfId =1 where name = 'Prosit';
update elf set bosselfId =2 where name = 'Butter';
update elf set bosselfId =1 where name = 'Blyger';
update elf set bosselfId =1 where name = 'Skumtomten';
update elf set bosselfId =2 where name = 'Gladtomten';

select * from elf;
select * from bosself;
-- todo: update all FKs in elf table
